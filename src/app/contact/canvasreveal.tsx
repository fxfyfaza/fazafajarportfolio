...
export function CanvasRevealEffectDemo() {
  return (
    <div className="py-0 flex flex-col lg:flex-row items-center justify-center bg-gray-900 dark:bg-black w-full gap-0.5 mx-auto px-8">
      <Card
        title="Instagram@fxfyfaza"
        icon={<InstagramIcon />}
        link="https://www.instagram.com/fxfyfaza"
      >
        <CanvasRevealEffect
          animationSpeed={5.1}
      ...
      <Card
        title="GitHub@fxfyfaza"
        icon={<GithubIcon />}
        link="https://github.com/fxfyfaza"
      >
        <CanvasRevealEffect
          animationSpeed={3}
      ...
      <Card
        title="LinkedIn"
        icon={<LinkedinIcon />}
        link="https://id.linkedin.com/in/fazafajarr"
      >
        <CanvasRevealEffect
          animationSpeed={3}
...
const Card = ({
  ...
  return (
    <a
      ...
      className="border border-black/[0.2] group/canvas-card flex items-center justify-center dark:border-white/[0.2] lg:max-w-xs w-full mx-auto p-2 relative h-[24rem] no-underline"
    >
      <AnimatePresence>
        {hovered && (
          <motion.div
